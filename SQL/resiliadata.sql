...
ALTER TABLE presenca 
FOREIGN KEY (presenca_aluno_facilitador_fk) 
REFERENCES presenca_aluno_facilitador(presenca_aluno_facilitador);

ALTER TABLE presenca 
FOREIGN KEY (presenca_aluno_monitor_fk) 
REFERENCES presenca_aluno_monitor (presenca_aluno_monitor_fk);

-- Presença Aluno Monitor

ALTER TABLE presenca_aluno_monitor  ADD CONSTRAINT presenca_aluno_monitor _modulo_fk_modulo_modulo FOREIGN KEY (modulo_fk) REFERENCES modulo(modulo);
...
ALTER TABLE presenca_aluno_facilitador ADD CONSTRAINT presenca_aluno_facilitador_modulo_modulo_modulo FOREIGN KEY (modulo) REFERENCES modulo(modulo);
